(function(){
  ...
  function parseNumber(input){ const s = toEnglishDigits(input==null?'':String(input)); const n = Number(s.replace(/,/g,'')); return isNaN(n)?0:n; }
  window.$dates = { toEnglishDigits, formatDateEn, today, parseNumber };
})();