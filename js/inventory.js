...
function saveInventory() {
  ...
  const date = (typeof formatDateEn==='function') ? formatDateEn(document.getElementById('inventoryDate').value || today) : (document.getElementById('inventoryDate').value || today);
