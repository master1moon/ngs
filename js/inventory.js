...
function saveInventory() {
  ...
  const date = (typeof getDateInputValue==='function') ? getDateInputValue('inventoryDate', today) : ((typeof formatDateEn==='function') ? formatDateEn(document.getElementById('inventoryDate').value || today) : (document.getElementById('inventoryDate').value || today));
