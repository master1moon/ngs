...
function addExpense() {
  ...
  if (typeof setExpenseDateInput === 'function') setExpenseDateInput(''); else document.getElementById('expenseDate').value = '';
...
function saveExpense() {
  ...
  const date = (typeof readExpenseDateInput === 'function') ? readExpenseDateInput() : formatDateEn(document.getElementById('expenseDate').value);
