(function(){
  ...
  function render(){
    ...
    root.innerHTML = ''+
      ...
      + '  <div class="col-md-3 d-flex gap-2"><button id="stApply" class="btn btn-primary w-100">تطبيق</button><button id="stExport" class="btn btn-outline-secondary w-100">تصدير TXT</button></div>'
      + '</div>'
